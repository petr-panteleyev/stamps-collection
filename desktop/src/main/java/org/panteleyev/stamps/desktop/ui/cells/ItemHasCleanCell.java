...
public class ItemHasCleanCell extends TreeTableCell<Object, Object> {
    @Override
    protected void updateItem(Object item, boolean empty) {
        ...
        var hasClean = switch (item) {
            case StampDTO stamp -> stamp.getHasClean();
            case BlockDTO block -> block.getHasClean();
            case CouplingDTO coupling -> coupling.getHasClean();
            default -> false;
        };
        var text = hasClean ? CHECK_SYMBOL : "";
        setText(text);
    }
}
